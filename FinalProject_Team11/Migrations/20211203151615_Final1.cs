        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    TotalCleaning = table.Column<decimal>(type: "decimal(18,2)", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    PropertyZip = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    WeekdayPrice = table.Column<decimal>(type: "decimal(18,2)", nullable: true),
                    WeekendPrice = table.Column<decimal>(type: "decimal(18,2)", nullable: true),
                    PropertyBedroom = table.Column<int>(type: "int", nullable: true),
                    PropertyBathroom = table.Column<int>(type: "int", nullable: true),
                    Pets = table.Column<bool>(type: "bit", nullable: false),
                    Parking = table.Column<bool>(type: "bit", nullable: false),
                    CleaningFee = table.Column<decimal>(type: "decimal(18,2)", nullable: true),
                    PropertyGuest = table.Column<int>(type: "int", nullable: true),
                    DiscountPercentage = table.Column<decimal>(type: "decimal(18,2)", nullable: true),
                    DiscountNights = table.Column<int>(type: "int", nullable: true),
                    UserId = table.Column<string>(type: "nvarchar(450)", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    TextReivew = table.Column<string>(type: "nvarchar(280)", maxLength: 280, nullable: true),
                    DisputeReview = table.Column<string>(type: "nvarchar(280)", maxLength: 280, nullable: true),
                    reviewnum = table.Column<int>(type: "int", nullable: false),
                    UserId = table.Column<string>(type: "nvarchar(450)", nullable: true),
                    PropertyID = table.Column<int>(type: "int", nullable: true)
                },
                constraints: table =>
